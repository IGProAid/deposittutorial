<html>
	...
	<body>		
		...
		<h1>JBL CHARGE 3+</h1>
	<h2>$99.95</h2>
	<img src="jblc3.jpeg" ALIGN="top" hspace="170">
	<table style="width:100%">
		</center>
		<center>
	<button><a href="login.html">Buy Now</a></button>
	<p>Output power (W)2 x 10, Music playing time (hrs)20<br>Dimensions (in)8.38 x 3.42 x 3.48, Dimensions (cm)21.3 x 8.7 x 8.85, Weight (kgs)0.8, Weight (lbs)1.76<br>Bluetooth version4.1<br>Battery capacity (mAh)6,000, Charging time (hrs)4.5<br></p>
		</center>
  </tr>
</table>
		</div>
