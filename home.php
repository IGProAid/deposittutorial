<html>
	...
	<body>		
		...
		<ul id="rig">
		<li>
        <a class="rig-cell" href="oppoa3s1.php">
		...
		<li>
        <a class="rig-cell" href="iphonex1.php">
		...
		<li>
        <a class="rig-cell" href="nex1.php">
		...
		<li>
        <a class="rig-cell" href="j7pro1.php">
		...
		<li>
        <a class="rig-cell" href="mate201.php">
		...
		<li>
        <a class="rig-cell" href="findx1.php">
		...
		<br><br>
		<h2><center>BLUETOOTH SPEAKERS ON SALE!</center></h2>
		<ul id="rig">
		<li>
        <a class="rig-cell" href="jblx1.php">
            <img class="rig-img" src="jblx.jpeg">
            <span class="rig-overlay"></span>
            <span class="rig-text">JBL XTREME Portable</span>
        </a>
		</li>
		<li>
        <a class="rig-cell" href="jblc31.php">
            <img class="rig-img" src="jblc3.jpeg">
            <span class="rig-overlay"></span>
            <span class="rig-text">JBL Charge 3+</span>
        </a>
		</li>
		<li>
        <a class="rig-cell" href="beatsp+1.php">
            <img class="rig-img" src="beatsp+.png">
            <span class="rig-overlay"></span>
            <span class="rig-text">Beats Pill XL</span>
        </a>
		</li>
		<li>
        <a class="rig-cell" href="bosesm1.php">
            <img class="rig-img" src="bosesm.png">
            <span class="rig-overlay"></span>
            <span class="rig-text">Bose Sounlink Mini</span>
        </a>
		</li>
		</ul>
		</div>
