<html>
	...
	<body>		
		...
		<h1>LG Thin	Q</h1>
		<h2>P17,500</h2>
		<img src="g7.jpg" ALIGN="top" hspace="170">
		<table style="width:100%">
		</center>
		<center>
		<button><a href="login.html">Buy Now</a></button>
		<p>Qualcomm SDM845 Snapdragon 845<br>128 GB, 6 GB RAM or 64 GB, 4 GB RAM<br>6.1" 2k+ IPS LCD 16M Colors Panel All Screen Display Notch<br>Android 8.1 (Oreo)<br>16 MP, f/1.6, 30mm (wide), 1/3.1", 1.0µm, OIS, PDAF & laser AF, 16 MP, f/1.9, 16mm (ultrawide), 1/3.1", no AF Rear Camera<br>8 MP, f/1.9, 26mm (wide) Front Camera</br></p>
		</center>
		</tr>
		</table>
		</div>
