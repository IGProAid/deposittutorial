<html>
	...
	<body>		
		...
		<h1>Oppo Find X</h1>
	<h2>P60,500</h2>
	<img src="findx.jpg" ALIGN="top" hspace="170">
	<table style="width:100%">
		</center>
		<center>
	<button><a href="login.html">Buy Now</a></button>
	<p>Qualcomm Snapdragon 845 Octa-core (4x2.8 GHz Kryo 385 Gold & 4x1.7 GHz Kryo 385 Silver)<br>128/256 GB, 8 GB RAM<br>6.42" FHD+ All Screen OLED Display<br>Android 8.0 (Oreo)<br>Motorized pop-up 16 MP, f/2.0, 1/2.6", 1.22µm, PDAF, OIS20 MP, f/2.0, 1/2.8", 1.0µm Rear Camera<br>Motorized pop-up 25 MP, f/2.0 Front Camera</br></p>
		</center>
  </tr>
</table>
		</div>
