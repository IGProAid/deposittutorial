<html>
	...
	<body>		
		...
		<h1>Oppo A3s</h1>
		<h2>P6,500</h2>
		<img src="a3s.jpg" ALIGN="top" hspace="170">
		<table style="width:100%">
		</center>
		<center>
		<button><a href="login.html">Buy Now</a></button>
		<p>Octa-Core Qualcomm SnapDragon 450<br>3GB RAM 32GB Internal Storage<br>6.2" HD+ IPS LCD 16M Colors Panel All Screen Display Notch<br>Android 8.1 (Oreo); ColorOS 5.1<br>13 MP, f/2.2, AF, 2 MP, f/2.4, depth sensor Rear Camera<br>8 MP, f/2.2 Front Camera</br></p>
		</center>
		</tr>
		</table>
		</div>
