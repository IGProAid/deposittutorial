<html>
	...
	<body>		
		...
		<h1>Vivo Nex S</h1>
	<h2>P35,500</h2>
	<img src="nex.jpg" ALIGN="top" hspace="170">
	<table style="width:100%">
		</center>
		<center>
	<button><a href="login.html">Buy Now</a></button>
	<p>Qualcomm Snapdragon 845 Octa-core (4x2.7 GHz Kryo 385 Gold & 4x1.7 GHz Kryo 385 Silver)<br>128/256 GB, 8 GB RAM<br>6.59" FHD+ Super AMOLED Panel All Screen Display<br>Android 9.0 (Pie)<br>12 MP, f/1.8, 1/2.55", 1.4µm, 4-axis OIS, dual pixel PDAF 5 MP, f/2.4, depth sensor Rear Camera<br>Motorized pop-up 8 MP, f/2.0 Front Camera</br></p>
		</center>
  </tr>
</table>
		</div>
